package com.domain.api.security.addons;
 ...
 */
@Component
public final class CorsCookieCsrfTokenRepository implements CsrfTokenRepository {
	...
	public CorsCookieCsrfTokenRepository() {
	...
	/**
	 * Set the domain that the Cookie will be created with. This will override the default (no domain)
	 * @param domain the domain the Cookie is issued for
	 */
