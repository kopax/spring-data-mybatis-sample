...
import com.domain.api.interfaceconfigs.OAuthClientDetails;
import com.domain.api.mybatis.typehandlers.CommaSeparatedTypeHandler;
import com.domain.api.mybatis.typehandlers.JsonMapTypeHandler;
...
public class OAuthClient implements OAuthClientDetails<Manager, Role>, ClientDetails, Persistable<String> {
